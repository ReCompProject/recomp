...
namespace ReComp.Areas.Admin.Controllers
{
    public class UsersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name_Surname,Mail,Number,Type_ID,Password")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name_Surname,Mail,Number,Type_ID,Password")] User user)
        {
            if (ModelState.IsValid)
            {
